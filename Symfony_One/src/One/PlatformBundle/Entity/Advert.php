 ...
 * @ORM\Entity(repositoryClass="One\PlatformBundle\Repository\AdvertRepository")
 */
...
class Advert
{
   ...
   */
    ...
    /**
   * @ORM\OneToOne(targetEntity="One\PlatformBundle\Entity\Image", cascade={"persist", "remove"})
   */
  private $image;
